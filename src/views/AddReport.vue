<template>
  <div>
    ...
    <form v-else-if="&& !hasValidatedForm" @submit.prevent="sendForm">
      ...
      <button type="submit" :disabled="!location || !(consumableProducts.length || reportedProducts.length) || isSendingForm" class="btn btn-primary">Submit</button>
...
export default {
  ...
  data() {
    return {
      ...
      activitiesList: [],
      activity: null,
      activityStartTimestamp: activityStartTimestamp.value,
